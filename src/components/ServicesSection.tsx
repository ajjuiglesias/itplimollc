...
export const ServicesSection: React.FC = () => {
  ...
  return (
    <section id="services" className="py-20 sm:py-28 bg-white dark:bg-[#141414] transition-colors duration-500 overflow-hidden border-t border-black/5 dark:border-white/5">
