...
export const FleetSection: React.FC<FleetSectionProps> = ({ onSelectVehicle }) => {
  ...
  const fleet = [
    ...
    },
    {
      ...
      category: 'Private Jet Van',
      tagline: 'Mobile Office & Group Sanctuary',
      passengers: '12 Passengers',
      luggage: '12 Large Luggage Cases',
      image: '/images/sprinter.png',
      description:
        'Custom jet-converted cabin for financial roadshows, corporate teams, and private airport groups. Stand-up headroom, conference seating, and Apple TV connectivity.',
      specs: [
        'Conference seating arrangement with desk tables',
        'Integrated Smart TV & presentation screen',
        'High-output 110V AC power outlets',
        'Full stand-up headroom interior cabin',
      ],
    },
  ];
